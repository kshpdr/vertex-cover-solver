...
#python3 ../../task-5/scripts/shit.py
...
#python_output=$(python3 /Users/koselev/Desktop/AlgEng/algorithm-engineering/task-5/scripts/get_complement_graph.py)
#python_output=$(python3 ../../task-5/scripts/get_complement_graph.py)
python3 ../../task-5/scripts/get_complement_graph.py
